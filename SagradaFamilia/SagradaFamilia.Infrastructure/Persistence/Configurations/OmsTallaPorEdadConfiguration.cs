...
{
    public class OmsTallaPorEdadConfiguration : IEntityTypeConfiguration<OmsTallaPorEdad>
    {
        public void Configure(EntityTypeBuilder<OmsTallaPorEdad> builder)
        {
            builder.ToTable("OMS_TallaPorEdad");
