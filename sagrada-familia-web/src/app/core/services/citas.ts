...
import { CitaCreate, CitaResponse, EstadoCita } from '../../shared/interfaces/cita.interface';
...
export class CitasService {
  ...
  cambiarEstado(id: number, nuevoEstado: EstadoCita | string | number): Observable<ApiResponse<null>> {
